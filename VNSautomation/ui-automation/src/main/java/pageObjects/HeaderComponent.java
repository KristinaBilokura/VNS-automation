...
public class HeaderComponent extends AbstractPage {
    ...
    private By searchLabel = By.xpath("//div[@class='search-input-wrapper nav-link']/div/img");
    ...
    public HeaderComponent clickOnSearchLabel() {
        executeActions().moveToElement(getElement(searchLabel, PRESENT)).perform();
        return this;
    }
    ...
    public HeaderComponent clickOnIconMessage() {
        getElement(iconMessage, VISIBLE).click();
        return this;
    }

    @Step("Verify Message wingow is displayed")
    public void verifyMessageWingowDisplayed() {
        By messageWingow = By.xpath("//div[@aria-label='Notification window']");
