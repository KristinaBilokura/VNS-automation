...
public class MainPage extends AbstractPage {
    ...
    private By searchIcon = By.xpath("//a[@id='label_3_8']//span");
    ...
    private By calendarIcon = By.xpath("//a[@id='label_3_9']//span");
    ...
    public void verifyMainPageComponentsDisplayed() {
        ...
        softAssert.assertTrue(isElementDisplayed(messages), "Verify messages displayed");
    ...
    public MainPage clickOnSearch() {
        getElement(searchIcon, CLICKABLE).click();
        return this;
    }
    ...
    public void verifysearchIsAvailable() {
        By search = By.xpath("//p[@class='errormessage']");
        Assert.assertFalse(getElement(search, VISIBLE).isDisplayed(), "Verify user can search");
    }
